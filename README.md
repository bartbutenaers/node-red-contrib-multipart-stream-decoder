...
Note that this flow requires that the wonderful [https://github.com/rikukissa/node-red-contrib-image-output](https://github.com/rikukissa/node-red-contrib-image-output) node is installed!
